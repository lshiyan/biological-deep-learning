...
from layers.hebbian_layer_with_attention import HebbianLayerWithAttention
from layers.classifier_layer import ClassifierLayer
from models.network import Network 

class HebbianNetworkWithAttention(Network): # Inherits from the Network base class
    """
    Constructor method
    @attr.
        PARENT ATTR.
    ...
    def __init__(self, args):
        ...
        attention_layer = HebbianLayerWithAttention(self.input_dim, self.heb_dim, self.device_id, self.heb_param["lamb"], self.lr, self.heb_param["gam"], self.eps)
        ...
        self.add_module("Attention Layer", attention_layer)
    ...
    def forward(self, x, clamped_output=None):
        ...
        attention_layer = self.get_module("Attention Layer")
        ...
        data_input = attention_layer(data_input)
