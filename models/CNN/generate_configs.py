...
def generate_cnn_config_files(base_config, output_dir="ConfigsCNN", num_layers=[1], whiten_values=[True], triangle_values=[True],
    greedytrain_values=[True], inhibition_values=['RePU'], pooling_values = ['NoPoolingStride1'], 
    mexicanhat_sigmas = [0.01, 0.05, 0.1, 0.5, 1, 1.5, 2.5, 5, 10], lambdas = [-0.5, 0.1, 0.5, 1, 5, 25, 125, 250, 500]):
