...
from layers.hopfield_YZZ.hyzz_classification_layer import HYZZClassificationLayer
from layers.hopfield_YZZ.hyzz_hebbian_layer import HYZZHebbianLayer
from layers.hopfield_YZZ.hyzz_input_layer import HYZZInputLayer
from layers.input_layer import InputLayer
from layers.output_layer import OutputLayer


class HYZZNetwork(Network):
    """
    CLASS
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        input_layer: InputLayer = HYZZInputLayer()
        hebbian_layer: HiddenLayer = HYZZHebbianLayer(self.input_dim, self.heb_dim, self.device, self.heb_param["lamb"], self.lr, self.heb_param["gam"], self.heb_param["eps"])
        classification_layer: OutputLayer = HYZZClassificationLayer(self.heb_dim, self.output_dim, self.device, self.lr)
