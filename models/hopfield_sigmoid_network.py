...
from layers.hopfield_sigmoid.hsig_classification_layer import HSigClassificationLayer
from layers.hopfield_sigmoid.hsig_hebbian_layer import HSigHebbianLayer
from layers.hopfield_sigmoid.hsig_input_layer import HSigInputLayer
from layers.input_layer import InputLayer
from layers.output_layer import OutputLayer


class HSigNetwork(Network):
    """
    CLASS
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        input_layer: InputLayer = HSigInputLayer()
        hebbian_layer: HiddenLayer = HSigHebbianLayer(self.input_dim, self.heb_dim, self.device, self.heb_param["lamb"], self.lr, self.heb_param["gam"], self.heb_param["eps"])
        classification_layer: OutputLayer = HSigClassificationLayer(self.heb_dim, self.output_dim, self.device, self.lr)
