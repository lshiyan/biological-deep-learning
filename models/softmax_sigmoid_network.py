...
from layers.softmax_sigmoid.ssig_classification_layer import SSigClassificationLayer
from layers.softmax_sigmoid.ssig_hebbian_layer import SSigHebbianLayer
from layers.softmax_sigmoid.ssig_input_layer import SSigInputLayer 


class SSigNetwork(Network):
    """
    CLASS
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        input_layer: InputLayer = SSigInputLayer()
        hebbian_layer: HiddenLayer = SSigHebbianLayer(self.input_dim, self.heb_dim, self.device, self.heb_param["lamb"], self.lr, self.heb_param["gam"], self.heb_param["eps"])
        classification_layer: OutputLayer = SSigClassificationLayer(self.heb_dim, self.output_dim, self.device, self.lr)
